...
## Environments
- Preview: https://main--guidehouse--aemysites.aem.page/
- Live: https://main--guidehouse--aemysites.aem.live/
- Block Library: https://main--guidehouse--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `guidehouse` directory in your favorite IDE and start coding :)
